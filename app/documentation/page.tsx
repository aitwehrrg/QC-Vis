          ...
          <div className="docs-layout">
            ...
            <div className="max-w-3xl">
              ...
              <section id="documentation">
                ...
                <div className="my-6">
                  <LatticeCanvas gridSize={PARAMS.n} showNoise={true} noiseMagnitude={0.3} height={240} />
                </div>
                <p className="text-sm" style={{ color: "var(--muted)" }}>
                  In the lattice view above, clean grid points represent ideal algebraic structure. The displaced points show how noise perturbs values. The perturbation is small enough that the legitimate recipient can tolerate it (by rounding), but large enough that an attacker cannot strip it away to recover the secret.
                </p>
